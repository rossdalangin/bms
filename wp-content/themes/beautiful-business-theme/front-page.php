...
<div id="primary" class="content-area homepage-content-area">
    <main id="main" class="site-main homepage-main">
        ...
        if ( ! empty( $bbt_hero_background_image ) ) {
            ...
            $bbt_hero_section_classes .= ' no-background-image';
        }
        ?>
        ...
        for ( $i = 1; $i <= 3; $i++ ) { if ( get_theme_mod( "bbt_feature_{$i}_title", '' ) ) { $bbt_display_features = true; break; } }
            ...
            <div class="container">
                <div class="features-grid">
                    ...
                    <div class="feature-item">
                        <?php if ( ! empty( $bbt_icon ) ) : ?><span class="dashicons <?php echo esc_attr( $bbt_icon ); ?>"></span><?php endif; ?>
        ...
        for ( $i = 1; $i <= 4; $i++ ) { if ( get_theme_mod( "bbt_client_logo_{$i}" ) ) { $bbt_display_logos = true; break; } }
        ...
        <section id="cta-section" class="homepage-content-section homepage-cta-section">
            <div class="container">
                ...
                <?php $bbt_cta_btn_text = get_theme_mod( 'bbt_cta_button_text' );
                if ( $bbt_cta_btn_text ) : ?>
        ...
        $bbt_news_query = new WP_Query( array( 'post_type' => 'post', 'posts_per_page' => absint( $bbt_news_count ), 'ignore_sticky_posts' => 1, 'no_found_rows' => true ) );
        ...
        $bbt_services_query = new WP_Query( array( 'post_type' => 'service', 'posts_per_page' => absint( $bbt_services_count ), 'orderby' => 'date', 'order' => 'DESC', 'no_found_rows' => true ) );
        ...
        <section id="services-section" class="homepage-content-section homepage-services-section section-padding alternate-background">
            <div class="container">
                <?php if ( ! empty( $bbt_services_title ) ) : ?><h2 class="section-title"><span class="section-title-text"><?php echo esc_html( $bbt_services_title ); ?></span></h2><?php endif; ?>
        ...
        $bbt_projects_query = new WP_Query( array( 'post_type' => 'project', 'posts_per_page' => absint( $bbt_projects_count ), 'orderby' => 'date', 'order' => 'DESC', 'no_found_rows' => true ) );
        ...
        <section id="projects-section" class="homepage-content-section homepage-projects-section section-padding">
            <div class="container">
                <?php if ( ! empty( $bbt_projects_title ) ) : ?><h2 class="section-title"><span class="section-title-text"><?php echo esc_html( $bbt_projects_title ); ?></span></h2><?php endif; ?>
        ...
        $bbt_testimonials_query = new WP_Query( array( 'post_type' => 'testimonial', 'posts_per_page' => absint( $bbt_testimonials_count ), 'orderby' => 'date', 'order' => 'DESC', 'no_found_rows' => true ) );
        if ( $bbt_testimonials_query->have_posts() ) : ?>
        <section id="testimonials-section" class="homepage-content-section homepage-testimonials-section section-padding alternate-background">
            <div class="container">
                <?php if ( ! empty( $bbt_testimonials_title ) ) : ?><h2 class="section-title"><span class="section-title-text"><?php echo esc_html( $bbt_testimonials_title ); ?></span></h2><?php endif; ?>
