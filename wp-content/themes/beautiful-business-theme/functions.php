 ...
 * @return array
 */
function beautiful_business_body_classes( $classes ) {
    ...
    if ( get_theme_mod( 'bbt_screen_width', 'default' ) === 'fullwidth' ) {
        $classes[] = 'layout-fullwidth';
    }

    return $classes;
}
add_filter( 'body_class', 'beautiful_business_body_classes' );
