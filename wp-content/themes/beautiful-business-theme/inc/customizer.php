...
function beautiful_business_customize_register( $wp_customize ) {
    ...
    $bbt_homepage_sections = array( 'hero' => 'Hero', 'features' => 'Features', 'services' => 'Services', 'projects' => 'Projects', 'cta' => 'CTA', 'clients' => 'Clients', 'testimonials' => 'Testimonials', 'news' => 'News' );
    foreach ( $bbt_homepage_sections as $id => $label ) {
        ...
        $wp_customize->add_control( 'bbt_show_section_' . $id . '_control', array( 'label' => sprintf( 'Show %s Section', $label ), 'section' => 'bbt_homepage_visibility_section', 'settings' => 'bbt_show_section_' . $id, 'type' => 'checkbox' ) );
    }
    ...
    $wp_customize->add_setting( 'bbt_homepage_section_order', array( 'default' => implode( ',', array_keys( $bbt_homepage_sections ) ), 'sanitize_callback' => 'beautiful_business_sanitize_section_order', 'transport' => 'postMessage' ) );
    $wp_customize->add_control( new Beautiful_Business_Reorder_Control( $wp_customize, 'bbt_homepage_section_order_control', array( 'label' => __( 'Homepage Section Order', 'beautiful-business' ), 'section' => 'bbt_homepage_order_section', 'settings' => 'bbt_homepage_section_order', 'choices' => $bbt_homepage_sections ) ) );
    ...
    $wp_customize->add_control( 'bbt_services_section_count_control', array( 'label' => __( 'Number of Services', 'beautiful-business' ), 'section' => 'bbt_homepage_services_section', 'settings' => 'bbt_services_section_count', 'type' => 'number' ) );
    ...
    $wp_customize->add_control( 'bbt_projects_section_count_control', array( 'label' => __( 'Number of Projects', 'beautiful-business' ), 'section' => 'bbt_homepage_projects_section', 'settings' => 'bbt_projects_section_count', 'type' => 'number' ) );
    ...
    $wp_customize->add_control( 'bbt_testimonials_section_count_control', array( 'label' => __( 'Number of Testimonials', 'beautiful-business' ), 'section' => 'bbt_homepage_testimonials_section', 'settings' => 'bbt_testimonials_section_count', 'type' => 'number' ) );
    ...
    for ($i = 1; $i <= 3; $i++) {
        ...
        $wp_customize->add_setting( "bbt_feature_{$i}_title", array( 'default' => sprintf(__( 'Feature %d', 'beautiful-business' ), $i), 'sanitize_callback' => 'sanitize_text_field', 'transport' => 'postMessage' ) );
        ...
        $wp_customize->add_setting( "bbt_feature_{$i}_text", array( 'default' => __( 'Enter a short description for this feature.', 'beautiful-business' ), 'sanitize_callback' => 'wp_kses_post', 'transport' => 'postMessage' ) );
    ...
    $wp_customize->add_setting( 'bbt_cta_button_text', array( 'default' => __( 'Contact Us', 'beautiful-business' ), 'sanitize_callback' => 'sanitize_text_field', 'transport' => 'postMessage' ) );
    ...
    $wp_customize->add_control( 'bbt_news_section_count_control', array( 'label' => __( 'Number of Posts', 'beautiful-business' ), 'section' => 'bbt_homepage_news_section', 'settings' => 'bbt_news_section_count', 'type' => 'number' ) );

}
add_action( 'customize_register', 'beautiful_business_customize_register', 20 );
